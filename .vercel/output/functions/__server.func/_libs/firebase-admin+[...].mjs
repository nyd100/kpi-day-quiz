...
var name$3, version$3, description$3, main$3, types$3, files$3, exports$3, scripts$3, repository$3, keywords$3, engines$3, author$3, license$3, devDependencies$3, dependencies$3, homepage$3, package_default$3;
var init_package$3 = __esmMin((() => {
	name$3 = "gaxios";
	version$3 = "7.3.1";
	description$3 = "A simple common HTTP client specifically for Google APIs and services.";
	main$3 = "build/cjs/src/index.js";
	types$3 = "build/cjs/src/index.d.ts";
	files$3 = ["build/"];
	exports$3 = { ".": {
		"import": {
	...
	homepage$3 = "https://github.com/googleapis/google-cloud-node/tree/main/core/packages/gaxios";
	package_default$3 = {
		name: name$3,
		version: version$3,
		description: description$3,
...
var require_util$2 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = { pkg: (init_package$3(), __toCommonJS(package_exports$3).default) };
}));
//#endregion
			...
			return (fields, ...args) => {
				...
				switch (fields.severity) {
					...
					case LogSeverity.WARNING:
						...
						break;
					default: level = (_a = fields.severity) !== null && _a !== void 0 ? _a : LogSeverity.DEFAULT;
				}
...
var require_pluggable_auth_client = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	*/
	var DEFAULT_EXECUTABLE_TIMEOUT_MILLIS = 3e4;
	/**
	* The minimum allowed executable timeout in milliseconds.
	*/
	var MINIMUM_EXECUTABLE_TIMEOUT_MILLIS = 5e3;
	/**
	* The maximum allowed executable timeout in milliseconds.
	*/
	var MAXIMUM_EXECUTABLE_TIMEOUT_MILLIS = 12e4;
	/**
	...
	var GoogleAuth = class {
		...
		*/
		async _tryGetApplicationCredentialsFromWellKnownFile(options) {
			...
			if (!fs$2.existsSync(location)) return null;
...
//#endregion
//#region node_modules/firebase-admin/lib/index.js
/*! firebase-admin v14.2.0 */
var require_lib = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	*/
	...
	if (Object.prototype.toString.call(processGlobal) !== "[object process]") console.error(`
======== WARNING! ========
