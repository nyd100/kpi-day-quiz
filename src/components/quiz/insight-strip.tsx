...
export function InsightStrip({
  ...
  return (
    <div className="surface-card mt-4 flex items-start gap-4 p-5 animate-in slide-in-from-bottom-4 fade-in duration-700 delay-1000 fill-mode-both border-s-4 border-s-accent bg-accent/5">
